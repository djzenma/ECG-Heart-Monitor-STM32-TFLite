...
#define AI_NETWORK_MODEL_SIGNATURE     "084fcb8c8056673c7d71383d802246e9"
...
#define AI_TOOLS_DATE_TIME   "Tue May 26 11:00:06 2020"
...
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 5,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    dense_3_weights_array, AI_ARRAY_FORMAT_LUT4_FLOAT,
    NULL, NULL, 250,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 50, 5, 1, 1), AI_STRIDE_INIT(4, 1, 25, 125, 125),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 50, 50, 1, 1), AI_STRIDE_INIT(4, 1, 25, 1250, 1250),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 187, 50, 1, 1), AI_STRIDE_INIT(4, 1, 94, 4700, 4700),
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_3_bias_array.data = AI_PTR(weights + 6672);
    dense_3_bias_array.data_start = AI_PTR(weights + 6672);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights + 6544);
    dense_3_weights_array.data_start = AI_PTR(weights + 6480);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights + 6280);
    dense_2_bias_array.data_start = AI_PTR(weights + 6280);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights + 5028);
    dense_2_weights_array.data_start = AI_PTR(weights + 4964);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 4764);
    dense_1_bias_array.data_start = AI_PTR(weights + 4764);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights + 64);
